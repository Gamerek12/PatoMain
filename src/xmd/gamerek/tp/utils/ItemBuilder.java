...
public class ItemBuilder
{
    ...
    public ItemBuilder addEnchantment(final Enchantment enchant, final int level, boolean b) {
    ...
    public ItemStack build() {
        ...
        item.addUnsafeEnchantments((Map<Enchantment, Integer>)this.enchants);
        if (this.potion != null) {
    ...
    public ItemBuilder clone() throws CloneNotSupportedException {
        ...
        for (final Map.Entry<Enchantment, Integer> entry : this.enchants.entrySet()) {
            newBuilder.addEnchantment(entry.getKey(), entry.getValue(), true);
        }
